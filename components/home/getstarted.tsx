...
//   return (
//     <div
//       className="flex justify-center items-center px-40 h-[600px] border-2 border-black "
//       style={{ backgroundImage: `url(${bgform.src})` }}
//     >
//       <div className="flex flex-col space-y-12 w-1/2 border-2 border-black">
//         <div className="text-4xl">
//           Get Started
//           <br />
//           <span className="font-semibold leading-normal">Quickly & Easily</span>
//         </div>
//         <div className="font-normal text-sm leading-6 tracking-wide">
//           You don’t have to worry about the technology. You don’t even have to
//           worry about choosing the right strategy. You’ll get historical data of
//           each of the built-in settings, so you can easily see the best strategy
//           that works for you.
...
//           <br /> this opportunity.
//         </div>
//         <div>So why wait any longer?</div>
//       </div>
//       <div className="w-1/2 flex items-end  border-2 border-black">
//         <Image src={phone} alt="bgform" />
//       </div>
//     </div>
//   );
// };
