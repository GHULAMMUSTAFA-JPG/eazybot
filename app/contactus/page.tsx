    ...
    <div>
      ...
      >
        ...
        <div className="text-md leading-6 tracking-wider">
          ...
          <span className="font-semibold">EazyBot Team</span> using email
          <br />
          <span className="font-semibold">support@EazyBot.com</span>
          or our
          <span className="font-semibold">Official Telegram Channel.</span>
        </div>
        <div>
          <div className="flex justify-center items-start w-full pb-6">
            <button
              onClick={() => {}}
              className="bg-hcolor text-white rounded-full w-full md:w-fit shadow-2xl shadow-hcolor hover:bg-white hover:text-hcolor py-3 px-10 transition duration-300 transform hover:-translate-y-2"
            >
              Telegram Chanel
            </button>
          </div>
